...
public class TrabalhoLFA {
	...
	public static void main(String[] args) {
		...
		if (resposta == JFileChooser.APPROVE_OPTION) {
			...
			JOptionPane.showMessageDialog(null, "ERRO! Nenhum arquivo selecionado","ERRO!",JOptionPane.ERROR_MESSAGE);
			return;
		}
		...
		if (resposta == JFileChooser.APPROVE_OPTION) {
			...
			JOptionPane.showMessageDialog(null, "ERRO! Nenhuma pasta selecionada","ERRO!",JOptionPane.ERROR_MESSAGE);
			return;
		}
